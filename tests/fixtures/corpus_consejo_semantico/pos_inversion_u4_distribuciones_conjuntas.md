...
En el análisis bivariado de propiedades fisicoquímicas de nanopartículas coloidales, la distribución de probabilidad conjunta permite evaluar el impacto simultáneo de dos variables críticas para la estabilidad de una suspensión: el **diámetro de partícula** $X$ (en nm) y el **potencial zeta** $Y$ (en mV, una medida de la carga superficial efectiva que gobierna la repulsión electrostática entre partículas). Estas dos variables no son independientes en un proceso real de síntesis: partículas más grandes tienden a exhibir un potencial zeta más positivo debido a la mayor área superficial disponible para la adsorción de iones estabilizantes (p. ej. citrato).
