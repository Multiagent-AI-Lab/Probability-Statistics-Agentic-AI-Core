...
**Interpretación de $\beta_1$ — Odds Ratio (razón de momios)**: si $x$ aumenta en una unidad, el *log-odds* de éxito disminuye en $\beta_1$; equivalentemente, la razón de momios $\text{ODDS}=\pi/(1-\pi)$ se multiplica por $e^{\beta_1}$ (el **odds ratio**).
