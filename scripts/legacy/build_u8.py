"""
Script para escribir UNIDAD_8_PROYECTO_INTEGRADOR.md de manera limpia sin errores de shell.
"""

u8_content = r"""# UNIDAD 8: Proyecto Integrador: Inferencia Estadística y Modelado en Nanotecnología e IA
...
with open('lecciones/UNIDAD_8_PROYECTO_INTEGRADOR.md', 'w', encoding='utf-8') as f:
    f.write(u8_content)

print("UNIDAD_8_PROYECTO_INTEGRADOR.md escrita correctamente!")
