...
> [!IMPORTANT]
> Este documento es la **Ley Suprema** para la remediación de las lecciones y notebooks. Ninguna entrega será aprobada por el `@QA` si no cumple estrictamente con los 8 componentes.

---

## 1. Regla de Oro: Los 8 Componentes Obligatorios
...
8. **Interpretación y Diccionario**:
   - **8a. Interpretación Post-Gráfico**: $\ge 150$ palabras de análisis físico/estadístico.
   - **8b. Diccionario de Variables**: Tabla con variable, nombre físico, unidades y descripción.
